import { ChainId, JSBI, Percent, Token, WETH as _WETH } from '@ufomoney/newsdk'
...
export const PNG: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'PNG', 'Pangolin')
}
...
export const USDT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 6, 'USDT', 'Tether USD')
}
...
export const WBTC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 8, 'WBTC', 'Wrapped Bitcoin')
}
...
export const DAI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'DAI', 'DAi Stablecoin')
}
...
export const TRI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'TRI', 'Trisolaris Token')
}
...
export const XTRI: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'xTRI', 'TriBar Token')
}
...
export const AURORA: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'AURORA', 'Aurora')
}
...
export const UST: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'UST', 'Wrapped UST')
}
...
export const LUNA: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'LUNA', 'Wrapped LUNA')
}
...
export const USDC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 6, 'USDC', 'USDC Stablecoin')
}
...
export const AAVE: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'AAVE', 'AAVE TOken')
}
...
export const WNEAR: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'WNEAR', 'WNEAR Token')
}
...
export const AVAX: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'AVAX', 'Avalanche')
}
...
export const MATIC: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'MATIC', 'Polygon')
}
...
export const BNB: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC]: new Token(ChainId.BSC, ZERO_ADDRESS, 18, 'BNB', 'Binance')
}
...
const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.BSC]: [DAI[ChainId.BSC], USDT[ChainId.BSC]]
}
